// Legacy Pattern B factory tests — button + label only (the factories
// retained for src/demos/legacy-demo). The other seven factories were
// deleted in the Pattern A migration; their behavior contracts live on in
// src/components/headless/*.test.ts against the DOM-first replacements.

import { afterAll, beforeAll, beforeEach, describe, expect, it } from 'vitest';
import { __resetNodeIds } from '@tesyl/screean';
import {
