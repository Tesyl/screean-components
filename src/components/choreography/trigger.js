...
const swapInternals = (c, newHandlers) => {
...
const withHandler = (base, eventName, handler) => Object.freeze({ ...base, [eventName]: handler });
...
export const onEvent = (runner, c, eventName, pipeline) => {
...
export const onState = (runner, c, predicate, paired) => {
    let last = predicate();
    const handle = {
        dispose: () => {
